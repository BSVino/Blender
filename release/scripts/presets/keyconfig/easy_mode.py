...
kc = wm.keyconfigs.new('Easy Mode')
...
kmi = km.keymap_items.new('view3d.select_circle', 'LEFTMOUSE', 'PRESS')
kmi.properties.radius = 3
kmi.properties.extend = 0
kmi.properties.confirm_on_release = 1
kmi = km.keymap_items.new('view3d.select_circle', 'LEFTMOUSE', 'PRESS', shift=True)
kmi.properties.radius = 3
kmi.properties.extend = 1
kmi.properties.confirm_on_release = 1
kmi = km.keymap_items.new('view3d.select_circle', 'LEFTMOUSE', 'PRESS', ctrl=True)
kmi.properties.radius = 3
kmi.properties.extend = 0
kmi.properties.confirm_on_release = 1
...
kmi = km.keymap_items.new('view3d.edit_mesh_extrude_move_normal', 'X', 'PRESS')
...
kmi = km.keymap_items.new('view3d.manipulator', 'LEFTMOUSE', 'PRESS', any=True)
kmi.properties.release_confirm = True
kmi = km.keymap_items.new('transform.context', 'ACTIONMOUSE', 'PRESS')
kmi.properties.tap_confirm = True
kmi.properties.drag_drop = True
...
kmi = km.keymap_items.new('view3d.mouseover', 'MOUSEMOVE', 'ANY')
...
kmi = km.keymap_items.new('mesh.selection_mode_set', 'A', 'PRESS')
kmi.properties.mode = 'VERTEX'
kmi = km.keymap_items.new('mesh.selection_mode_set', 'S', 'PRESS')
kmi.properties.mode = 'EDGE'
kmi = km.keymap_items.new('mesh.selection_mode_set', 'D', 'PRESS')
